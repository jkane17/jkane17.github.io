...
end:/$/}]}}})();hljs.registerLanguage("diff",e)})();/*! `javascript` grammar compiled for Highlight.js 11.11.1 */
(()=>{var e=(()=>{"use strict"
...
illegal:"\\S"}}})();hljs.registerLanguage("json",e)})();/*! `less` grammar compiled for Highlight.js 11.11.1 */
(()=>{var e=(()=>{"use strict"
...
;hljs.registerLanguage("less",e)})();/*! `makefile` grammar compiled for Highlight.js 11.11.1 */
...
match:/[-+*/=%^~]|&&?|\|\|?|!=?|<(?:=>?|<|>)?|>[>=]?/,relevance:0}]}}})()
;hljs.registerLanguage("sql",e)})();/*! `wasm` grammar compiled for Highlight.js 11.11.1 */
